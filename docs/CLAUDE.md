...
```
docs/spec/VILSAY_TECH_ARCH.md     技术架构、接口定义、数据结构
docs/spec/VILSAY_UI_UX.md         界面规范、文案规范、交互规范
docs/status/VILSAY_DEV_TASKS.md   任务清单、当前进度、验收标准
docs/status/WEEK4_CURSOR_TASKS.md  Week 4：10 个可执行任务（客户端 4 + 服务端 6）+ 生产上线清单
docs/status/VILSAY_PHASE1_3_NOTES.md  第 1～3 阶段交付说明、环境变量、已知边界
docs/status/PHASE_PROGRESS_2026_03_25.md  阶段进度（热键模式、百炼/润色、测试）
docs/status/API_KEYS_AND_SECRETS.md  API Key 与安全（勿入库）
docs/spec/voice_polish_prompt.md  V2 Prompt 完整设计（与 `Prompts`/`PromptComposer` 对齐）
```
